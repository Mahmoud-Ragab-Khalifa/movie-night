  ...
  return (
    <section className="flex flex-col-reverse lg:flex-row gap-5 items-start lg:gap-20 xl:gap-30 flex-1 w-full pb-8 md:pb-0">
      <div className="flex flex-col gap-5">
        <div className="grid gap-0.5 animate-fade-in-lg">
          <span className="text-sm text-muted-foreground">Email:</span>
          <span className="text-lg text-foreground">{userProfile.email}</span>
        </div>

        {userProfile.user_name && (
          <div className="grid gap-0.5 animate-fade-in-lg animation-delay-100">
        ...
        {userProfile.full_name && (
          <div className="grid gap-0.5 animate-fade-in-lg animation-delay-200">
        ...
        {userProfile.bio && (
          <div className="grid gap-0.5 animate-fade-in-lg animation-delay-300">
        ...
        {userProfile.phone && (
          <div className="grid gap-0.5 animate-fade-in-lg animation-delay-400">
            <span className="text-sm text-muted-foreground">Phone:</span>
            <span className="text-lg text-foreground">{userProfile.phone}</span>
          </div>
        )}

        <div className="grid gap-0.5 animate-fade-in-lg animation-delay-500">
      ...
      {userProfile.image_url && (
        <div className="relative w-50 h-50 rounded-full overflow-hidden mx-auto md:mx-0 animate-fade-in-lg animation-delay-600">
          <Image
